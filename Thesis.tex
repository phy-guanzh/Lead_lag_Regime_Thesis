...
%\\$w$ & The weight vector}
\listofsymbols{|l|p{0.72\linewidth}|}{
...
DI\text{-}SIM & Directed spectral clustering (DI--SIM) \\
CCF & Cross-Correlation Function \\
AUC & Area Under the Curve \\
ARI & Adjusted Rand Index \\
MI & Mutual Information \\   % ← 补上
...
$\mathcal{U}$ & Investable universe tradable set \\  % ← 建议也补上
}
